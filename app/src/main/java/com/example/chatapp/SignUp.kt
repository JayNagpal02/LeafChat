...
class SignUp : AppCompatActivity() {
     ...
     * previous state if it was previously destroyed and recreated by the system. It is a Bundle object
     * that contains the data saved by the onSaveInstanceState() method.
     */
     ...
     * @param email The email parameter is a string that represents the email address of the user.
     * @param uid The "uid" parameter is a unique identifier for the user. It is typically generated by
     * the authentication system and is used to uniquely identify each user in the database.
     */
